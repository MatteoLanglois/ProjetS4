...
def FaceRecog(img, face_cascade, eye_cascade, smile_cascade):
...
for I in range(len(img_with)):
    img_with_edit = FaceRecog(img_with[I], face_cascade, eye_cascade, smile_cascade)
    img_without_edit = FaceRecog(img_without[I], face_cascade, eye_cascade, smile_cascade)
    img_incorrect_edit = FaceRecog(img_incorrect[I], face_cascade, eye_cascade, smile_cascade)
